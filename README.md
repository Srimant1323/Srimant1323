...
**Open to remote data analyst roles, bioinformatics research positions, and freelance projects.**<br/>
...
## 🚀 Deployed apps — quick overview

| | Project | What it does | Stack | Link |
|:---:|---|---|---|:---:|
| 🏍️ | [**HandRide — Bike Game**](https://github.com/Srimant1323/handride-bike-game) | Gesture-controlled bike racing game — tilt palm to steer, fist to brake, open hand to boost | MediaPipe · Canvas · JS · Netlify | [→ Repo](https://github.com/Srimant1323/handride-bike-game) |
| 🤖 | [**AI Gesture Mirror**](https://github.com/Srimant1323/ai-gesture-mirror) | Real-time hand gestures trigger fire, plasma, aura, hearts, stars effects — 2000 particles/frame | MediaPipe · Canvas · Vanilla JS · Netlify | [→ Live](https://brahmastra-303193.netlify.app/) |
| 🧬 | [**BioCalc App**](https://github.com/Srimant1323/biocalc-app) | No-code DNA, RNA & protein analysis toolkit for biologists who don't code | HTML · CSS · JS · Vercel | [→ Live](https://biocalc-app-six.vercel.app) |
| 🧠 | [**MindBridge App**](https://github.com/Srimant1323/MindBridge-app) | Full-stack ML app for mental health risk assessment — model to frontend, fully deployed | Python · scikit-learn · HTML/JS · Vercel | [→ Live](https://mind-bridge-app-rho.vercel.app) |

---

## 🚀 Deployed apps — the full story

---

### 🏍️ [HandRide — Gesture Controlled Bike Game](https://github.com/Srimant1323/handride-bike-game)

| | |
|---|---|
| **Type** | Browser game · No install required |
...
### 🤖 [AI Gesture Mirror](https://github.com/Srimant1323/ai-gesture-mirror) &nbsp;·&nbsp; [Live Demo →](https://brahmastra-303193.netlify.app/)

| | |
|---|---|
| **Type** | Real-time browser AI · No backend |
...
### 🧬 [BioCalc App](https://github.com/Srimant1323/biocalc-app) &nbsp;·&nbsp; [Live Demo →](https://biocalc-app-six.vercel.app)
...
### 🧠 [MindBridge App](https://github.com/Srimant1323/MindBridge-app) &nbsp;·&nbsp; [Live Demo →](https://mind-bridge-app-rho.vercel.app)

| | |
|---|---|
| **Type** | Full-stack ML web app |
| **Stack** | Python · scikit-learn · HTML · JavaScript · Vercel |
| **Architecture** | Trained ML model → Python backend → REST API → HTML/JS frontend |
| **Deployed** | Vercel — end-to-end live |
...
## 🔬 Research & analytics — quick overview

| | Project | What I did | Key outcome |
|:---:|---|---|---|
| 🏥 | [**Clinical Data Analysis**](https://github.com/Srimant1323/Clinical-data-analysis) | 600-patient oncology trial — MCAR/MAR/MNAR imputation, survival curves, XGBoost, SHAP | **AUC ~0.86** · Top predictor: EGFR · χ² p < 0.001 |
| 🦠 | [**COVID-19 RNA-seq PBMC**](https://github.com/Srimant1323/COVID19_rnaseq_pbmc_analysis) | Full RNA-seq pipeline — QC, normalisation, DEG, ORA, GSEA on COVID-19 vs healthy PBMCs | DEGs identified · Immune pathway enrichment confirmed |
| 💧 | [**Water Quality EDA**](https://github.com/Srimant1323/Water-Quality-Data-Analysis) | EDA on water potability across 10 chemical parameters — cleaning, correlation, distributions | [![Open in Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/Srimant1323/Water-Quality-Data-Analysis/blob/main/H20_Potability_EDA.ipynb) |
| 🧬 | [**Bioinformatics Practice**](https://github.com/Srimant1323/Bioinformatics-Basic-Practice) | Core bioinformatics algorithms implemented from scratch in Python | GC content · ORF detection · Hamming distance · Motif search · RNA translation |

---

## 🔬 Research & analytics — the full story

---

### 🏥 [Clinical Data Analysis](https://github.com/Srimant1323/Clinical-data-analysis)
...
### 🦠 [COVID-19 RNA-seq PBMC Analysis](https://github.com/Srimant1323/COVID19_rnaseq_pbmc_analysis)
...
| **Output** | DEGs + enriched immune pathways |
...
### 💧 [Water Quality Data Analysis](https://github.com/Srimant1323/Water-Quality-Data-Analysis)

| | |
|---|---|
| **Dataset** | Water potability — 10 chemical parameters |
| **Stack** | Python · pandas · seaborn · matplotlib · Google Colab |
| **Analysis** | Missing value handling · correlation heatmaps · distribution analysis |
...
### 🧬 [Bioinformatics Basic Practice](https://github.com/Srimant1323/Bioinformatics-Basic-Practice)

| | |
|---|---|
| **Type** | Algorithms implemented from scratch |
...
### 🏥 [Healthcare Analytics Dashboard](https://github.com/Srimant1323/healthcare-analytics-dashboard)

| | |
|---|---|
| **Type** | Clinical operations dashboard |
...
| Length of stay distribution | Column chart |
